...
We have CompStat [data for full years](./tables/markdown_table.annual_totals.md) beginning in 2018 for comparison:
...
Total offenses [by year and month](./tables/markdown_table.monthly_incidents.md):
