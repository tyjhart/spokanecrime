...
```{r plot.weekly_offense_comparisons, fig.cap = "Offenses by Week, 2018 Onward"}
df.crimes %>%
...
```{r plot.weekly_district_offense_comparisons, fig.cap = "Offenses by Month, District"}
df.crimes %>%
filter(date >= "2018-01-01" & date <= "2019-12-31") %>%
...
labs(
  x = "Month",
  y = "Offenses",
  title = "Offenses by Month, District",
  subtitle = "2018 - 2019",
  color = "Year"
  ) +
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
