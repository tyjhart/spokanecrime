...
### Figure captions ###
data_source_str <- "DATA SOURCE: Spokane Police Department CompStat"
...
end_date <- as.numeric(as.Date("2020-08-15") - as.Date("2020-01-01")) # Last 2020 observed date
