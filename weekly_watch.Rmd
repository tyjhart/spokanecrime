...
ggplot(a, aes(x = reorder(district, -n, sum), y = n, fill = violence, label = n)) +
  ...
  labs(
    x = "Police Districts", 
    y = "Offenses", 
    title = "Offense Types by District, 2017-2020", 
    caption = paste(data_source_str, cc_by_sa, sep = "\n")
    )
```
...
```{r plot.boxplot_p1_p4_avg_daily_by_month, fig.cap = "North Policing Districts, Daily Offenses by Month", fig.pos="H", fig.width=9.5, fig.height=6.5}
a <- df.crimes %>%
...
```{r plot.boxplot_p5_p8_avg_daily_by_month, fig.cap = "South Policing Districts, Daily Offenses by Month", fig.pos="H", fig.width=9.5, fig.height=6.5}
a <- df.crimes %>%
