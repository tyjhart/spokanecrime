...
df.crimes %>%
  ...
  labs(
    x = "Police Districts", 
    title = "Incidents by Police District, 2023 YTD", 
...
df.crimes %>%
  ...
  labs(
    x = "Police Districts", 
    title = "Incidents by Police District, 2017 - 2023",
    caption = spokane_caption_exclude_dist
    ) +
  scale_y_continuous("Incidents", labels = comma, expand = c(.1, .1))
```
...
df.crimes %>%
  ...
  labs(
    x = "Police Districts", 
    y = "Incidents", 
    title = "Incident Violence by District, 2017-2023", 
    caption = paste(spokane_data_source_str, cc_by_sa, sep = "\n")
    )
```
...
df.crimes %>%
  ...
  labs(
    x = "Police Districts", 
    y = "Incidents", 
    title = "Incident Violence by District, 2023", 
    caption = paste(spokane_data_source_str, cc_by_sa, sep = "\n")
    )
```
...
df.crimes %>%
  ...
  labs(
    x = "", 
    title = "Incident Types, 2017-2023", 
    caption = spokane_caption
    ) +
  scale_y_continuous("Incidents", labels = comma, expand = c(.1, .1))
```
...
df.crimes %>%
  ...
  labs(
    x = "", 
    title = "Incidents by Day, 2023 YTD", 
    caption = spokane_caption
    ) +
  scale_y_continuous("Incidents", labels = comma, expand = c(.1, .1))
```
...
df.crimes %>%
  ...
  labs(
    x = "", 
    title = "Spokane Incidents by Day 2017 - 2023", 
    caption = spokane_caption
    ) +
  scale_y_continuous("Incidents", labels = comma, expand = c(.1, .1))
```
...
# Calculate start, end numerical dates
start_date <- as.numeric(as.Date("2017-08-01") - as.Date("2017-01-01")) # First 2017 observed date
end_date <- as.numeric(as.Date("2024-01-30") - as.Date("2024-01-01")) # Last 2021 observed date
freq <- 365 # Time series frequency

### All data time series ###
ts.crimes <- ts(model_data, start = c(2017,start_date), end = c(2024,end_date), frequency = freq)
