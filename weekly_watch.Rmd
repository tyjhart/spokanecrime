...
```{r plot.boxplot_p1_p4_avg_daily_by_month, fig.cap = "Daily Offenses by Month", fig.pos="H", fig.width=9.5, fig.height=6.5}
a <- df.crimes %>%
...
```{r plot.boxplot_p5_p8_avg_daily_by_month, fig.cap = "Daily Offenses by Month", fig.pos="H", fig.width=9.5, fig.height=6.5}
a <- df.crimes %>%
