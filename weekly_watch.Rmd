...
excluded_districts_note <- "NOTE: Excluding districts OTH, SPA-D"
...
daily_offenses %>%
  ...
  geom_smooth(method = NULL, color = "blue", size = geom_line_size) +
